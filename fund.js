...
class SqBase {
    ...
    osadka_add(obj_base_add) {
        ...
        let fund2procx = function (n1, n2, fund_vl) {
            let f1 = _.clone(fund_vl);
            let f2 = _.clone(fund_vl);
            f1.l = Math.abs(n1.x);
            f1.b = Math.abs(n1.y);
        ...
        if ((dx > (obj_base_add.b / 2)) && (dy > (obj_base_add.b / 2))) {
            let f1 = _.clone(obj_base_add);
            f1.l = p3.x;
            f1.b = p3.y;
            f1.sign = '+';
            let f2 = _.clone(obj_base_add);
            f2.l = p4.x;
            f2.b = p4.y;
            f2.sign = '-';
            let f3 = _.clone(obj_base_add);
            f3.l = p2.x;
            f3.b = p2.y;
            f3.sign = '-';
            let f4 = _.clone(obj_base_add);
            f4.l = p1.x;
            f4.b = p1.y;
            f4.sign = '+';
